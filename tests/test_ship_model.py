...
def test_replace_existing_ship_with_bad_id():
    ...
    assert db.replace_existing_ship(ship1) == False
    assert db.replace_existing_ship(ship2) == False


def test_replace_existing_ship_with_none_argument():
    assert db.replace_existing_ship(None) == False
